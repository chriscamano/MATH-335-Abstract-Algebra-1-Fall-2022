...
\begin{proof}
  ...
  so $e|d$
\end{proof}
\defn if the gcd of two intergers is equal to one they are called relatively prime. Note that in this case if two integers are relatively
,$gcd(a,b)=1=at+bu,t,u\in \Z$\\
\defn The counting function: Let $n>1, n\in \Z$ Let: \[
