...
Suppose that a does not divide c. This implies that $c=ak$
...
multiply by c
plug in ad=bc
implies that gcd is greater than one.
\end{proof}
...
\[
  l=\prod_{i=1}^kp_i^{max\{\alpha_i,\beta_i\}}
\]
then for each prime since$\delta_i>max(\alpha_i,\beta_i)$ this implies that l is smaller since $l|e$ since each exponent of the prime factors is smaller than that of the exponent in the prime factorizaion of e.
\end{proof}
 \end{enumerate}
